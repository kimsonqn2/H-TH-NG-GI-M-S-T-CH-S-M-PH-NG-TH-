...
st.sidebar.image("https://images.unsplash.com/photo-1477959858617-67f30bc75b82?w=500&auto=format&fit=crop&q=60", use_container_width=True)
...
with col1:
    ...
    # Biểu đồ cơ cấu phân loại loại đất
...
with col2:
    ...
    # Mô phỏng luồng thông lượng thời gian thực (MB/s) theo khung giờ
    ...
    # Biểu đồ độ trễ mạng biên (Edge Latency)
    ...
    # Tình trạng Gateway trạm thu nhận DT15
...
with col3:
    ...
    # Thống kê lệnh khớp và giao dịch
    ...
    # Sức khỏe các dịch vụ thành phần
    st.markdown("**Chỉ số SLA & Sức khỏe dịch vụ Sàn:**")
    st.markdown("""
    - 🟢 **API Gateway:** Uptime **99.99%** | 22ms latency
    - 🟢 **Matching Engine (Khớp lệnh chia sẻ dữ liệu):** Hoạt động bình thường
    - 🟢 **Smart Contract & Data Tokenizer:** 14,892 giao dịch hợp lệ
    - 🟢 **Data Pipeline Sandbox:** Tải 42% | Không có lỗi bảo mật
    """)
    
    # Top tập dữ liệu (Dataset) được giao dịch / truy vấn nhiều nhất
...
st.markdown("---")
st.info("💡 **Gợi ý tích hợp:** Bạn có thể kết nối trực tiếp các nguồn dữ liệu thời gian thực từ Kafka, PostgreSQL/PostGIS hoặc REST API vào các khung biểu đồ trên bằng cách thay thế hàm sinh dữ liệu mô phỏng.")
